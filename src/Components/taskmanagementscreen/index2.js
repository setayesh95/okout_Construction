...
function Task_managementStack2() {
  return (

      <Stack.Navigator screenOptions={{headerShown:false,gesturesEnabled:false}} initialRouteName={AddNewTask}>
...
export default Task_managementStack2;
